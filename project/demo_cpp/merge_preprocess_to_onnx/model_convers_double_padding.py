...
def insert_preprocess_nodes(
    ...
    graph.initializer.extend(
        [
            ...
            helper.make_tensor("half_int", TensorProto.INT64, [1], [2]),
    ...
    node_list.extend(
        [
            helper.make_node("Sub", ["const_640", "new_h_i"], ["pad_h"]),
            helper.make_node("Sub", ["const_640", "new_w_i"], ["pad_w"]),
            helper.make_node("Div", ["pad_h", "half_int"], ["pad_top"]),
            helper.make_node("Div", ["pad_w", "half_int"], ["pad_left"]),
            helper.make_node("Sub", ["pad_h", "pad_top"], ["pad_bottom"]),
            helper.make_node("Sub", ["pad_w", "pad_left"], ["pad_right"]),
            helper.make_node(
                "Concat",
                inputs=["pad_top", "pad_left", "pad_zero", "pad_bottom", "pad_right", "pad_zero"],
                outputs=["pads"],
                axis=0,
            ),
